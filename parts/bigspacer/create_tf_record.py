...
# APPEND python path and return to directory
...
def main(_):
  label_map_dict = label_map_util.get_label_map_dict('anot/label_map.pbtxt')

  logging.info('Reading from litty dataset.')
  image_dir = 'compress'
  annotations_dir = 'anot'
